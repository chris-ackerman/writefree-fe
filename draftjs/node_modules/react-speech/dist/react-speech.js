...
/***/ function(module, exports, __webpack_require__) {
	...
	var Speech = React.createClass({
	  ...
	  play: function() {
	    this.setSpeechSynthesis(); //never can get past this so it doesnt play 
	  ...
	  render: function() {
	    if (this.props.disabled || !SpeechSynthesis.supported()) {
	      return (
	        React.Element("span", {className: "rs-container", style: this.state.styles.container}, 
...
/** Function to Create Speech Synthesis - set voice, pitch, volume, etc. **/
/** Spring 2019 **/
 function(module, exports) {
